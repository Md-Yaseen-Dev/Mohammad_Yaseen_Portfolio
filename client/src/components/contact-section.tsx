                ...
                >
                  ...
                  >
                    <Textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      className="w-full px-4 py-3 text-black bg-background/50 border border-slate-700 rounded-lg focus:border-primary focus:outline-none transition-all backdrop-blur-sm"
