...
export default function ProjectsSection() {
  const projects = [
    ...
    },
    {
      ...
      description: "Created this project while learning React to strengthen my understanding of component-based development and state management. It demonstrates interactive UI elements and dynamic rendering.",
